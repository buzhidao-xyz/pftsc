...
namespace PftcsUITemplate.Util
{
    public class WindowBehaviorHelper
    {
        ...
        private void WmGetMinMaxInfo(IntPtr hwnd, IntPtr lParam)
        {
            ...
            if (monitor != IntPtr.Zero)
            {
                ...
                mmi.ptMaxSize.x = Math.Abs(rcWorkArea.right - rcWorkArea.left) + 11;
                mmi.ptMaxSize.y = Math.Abs(rcWorkArea.bottom - rcWorkArea.top) + 11;
